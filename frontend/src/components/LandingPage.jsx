...
const FEATURES = [
  {
    ...
    desc: "Advanced AI-powered facial recognition for accurate attendance tracking",
  },
  {
    icon: BarChart3,
    title: "Real-time Analytics",
    desc: "Get instant insights with comprehensive attendance reports and trends",
  },
  {
    icon: Clock,
    title: "Automated Scheduling",
    desc: "Set up classes and schedules with intelligent automation",
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    desc: "Instant alerts for absences and attendance irregularities",
  },
  {
    icon: FileText,
    title: "Export Reports",
    desc: "Generate detailed reports in multiple formats for easy sharing",
  },
];
          ...
          <div className="text-center relative z-10">
            ...
            <div className="flex gap-6 justify-center flex-wrap">
              ...
              <button
                ...
                className="px-8 py-4 bg-white/10 backdrop-blur-lg text-white rounded-xl font-semibold text-lg border-2 border-white/20 hover:bg-white/20 transform hover:scale-105 transition-all duration-300"
              >
                Watch Demo
              </button>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="relative w-full max-w-5xl bg-gray-900 rounded-2xl shadow-2xl overflow-hidden">
            ...
            <button
              ...
              className="absolute top-4 right-4 z-10 p-2 bg-white/10 hover:bg-white/20 rounded-full text-white transition-all duration-300"
            >
              <X className="w-6 h-6" />
            </button>
            ...
            <div className="p-6 bg-gradient-to-r from-purple-900/50 to-indigo-900/50">
              ...
              <p className="text-gray-300">
                See how our automated attendance system works in action
              </p>
            </div>
          </div>
        </div>
...
// Place your screen recording video file in your public folder as demo-video.mp4
// If your video has a different name, update the src attribute in the <video> tag
// The video path should be /your-video-name.mp4 (starting with / for files in the public folder)
